...
public class BluetoothLeService extends Service
{
    ...
    public final static UUID UUID_INTENSITY_MEASUREMENT = UUID.fromString(SampleGattAttributes.INTENSITY_MEASURE);
    ...
    private void broadcastUpdate(final String action,final BluetoothGattCharacteristic characteristic)
    {
        ...
        if (UUID_INTENSITY_MEASUREMENT.equals(characteristic.getUuid())) {
            format = BluetoothGattCharacteristic.FORMAT_UINT16;
            //int flag = characteristic.getProperties();
            Log.d(TAG, "intensity format int.");

            final int intensity = characteristic.getIntValue(format, 0);
            Log.d(TAG, String.format("Received intensity: %d", intensity));
            intent.putExtra(EXTRA_DATA, String.valueOf(intensity));
        }
        sendBroadcast(intent);
    }
